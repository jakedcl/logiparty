...
export async function TimeOffPanel({ orgId, canSubmit, canReview }: Props) {
  const [mine, pending] = await Promise.all([
    canSubmit ? listMyAvailabilityRequests(orgId) : [],
    canReview ? listPendingAvailabilityRequests(orgId) : [],
  ]);
